...
import { shiftMonthKey, monthKeyLabel, currentJakartaMonthKey } from "@/lib/date";
    ...
    <div className="flex items-center gap-2">
      ...
      <div className="relative">
        <input
          ...
          value={month}
          onChange={(e) => {
            if (e.target.value) router.push(`/finance?month=${e.target.value}`);
          }}
      ...
      {!isCurrent && (
        <Link
          ...
          className="text-xs font-medium text-rose hover:underline ml-1"
        >
          Bulan ini
        </Link>
      )}
